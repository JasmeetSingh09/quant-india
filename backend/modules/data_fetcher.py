...
NSE_SECTORS = {
    "Banking": [
        ...
        "RBLBANK.NS", "BANDHANBNK.NS", "DCBBANK.NS", "KARURVYSYA.NS",
    ],
    "NBFC": [
        "BAJFINANCE.NS", "BAJAJFINSV.NS", "MUTHOOTFIN.NS", "MANAPPURAM.NS",
        "CHOLAFIN.NS", "LTF.NS", "POONAWALLA.NS", "LICHSGFIN.NS", "CANFINHOME.NS",
        "RECLTD.NS", "PFC.NS", "IRFC.NS", "HUDCO.NS",
    ],
    "IT": [
        "TCS.NS", "INFY.NS", "WIPRO.NS", "HCLTECH.NS", "TECHM.NS",
        "LTTS.NS", "MPHASIS.NS", "COFORGE.NS", "PERSISTENT.NS", "OFSS.NS",
        "HEXT.NS", "KPITTECH.NS", "TATAELXSI.NS", "CYIENT.NS",
    ...
    "Power": [
        ...
        "TORNTPOWER.NS", "RPOWER.NS", "JSWENERGY.NS", "NHPC.NS", "SJVN.NS",
        "ADANIGREEN.NS",
    ],
    "Capital_Goods": [
        "LT.NS", "BHEL.NS", "SIEMENS.NS", "ABB.NS", "HAVELLS.NS",
        "CROMPTON.NS", "VOLTAS.NS", "BLUESTARCO.NS", "THERMAX.NS", "CGPOWER.NS",
        "AIAENG.NS", "GRINDWELL.NS",
    ],
    "Consumer_Durables": [
        "TITAN.NS", "WHIRLPOOL.NS", "BATAINDIA.NS", "VIPIND.NS", "RELAXO.NS",
        "SYMPHONY.NS", "ORIENTELEC.NS", "BAJAJELEC.NS", "MANYAVAR.NS",
    ...
    "Infra": [
        ...
        "IRB.NS", "KNRCON.NS", "GPPL.NS",
    ],
    "Chemicals": [
        "PIDILITIND.NS", "ASIANPAINT.NS", "BERGEPAINT.NS", "KANSAINER.NS",
        "NOCIL.NS", "DEEPAKNTR.NS", "AARTIIND.NS", "NAVINFLUOR.NS",
        "ALKYLAMINE.NS", "VINATIORGA.NS", "CLEAN.NS", "GALAXYSURF.NS",
    ],
    "Retail": [
        "DMART.NS", "ABFRL.NS", "TRENT.NS", "SHOPERSTOP.NS", "VMART.NS",
        "NYKAA.NS", "ETERNAL.NS", "PAYTM.NS", "POLICYBZR.NS",
    ],
    "Diversified": [
